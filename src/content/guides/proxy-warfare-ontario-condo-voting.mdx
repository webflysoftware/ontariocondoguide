...
featured: true
coverImage: chess-pieces.jpg
coverImageAlt: Chess pieces on a board, symbolizing strategic proxy and election battles in condo governance
faqs:
...
import heroImage from '../../assets/images/chess-pieces.jpg';

<figure class="not-prose -mx-4 my-8 overflow-hidden rounded-xl border border-border sm:mx-0">
  <Image
    src={heroImage}
    alt="Chess pieces on a board, symbolizing strategic proxy and election battles in condo governance"
  ...
  <figcaption class="border-t border-border bg-slate-50 px-4 py-3 text-sm text-slate-600">
    Proxy campaigns and election disputes can play out like a chess match — organized,
    high-stakes, and decided by who shows up.
  </figcaption>
</figure>
...
- When moving beyond paper proxies, evaluate a **secure platform with data hosted in Canada** — owner information and voting records should stay under Canadian jurisdiction. [ElectoSense](https://electosense.com) is one option built for Ontario condo elections, AGMs, and proxy-heavy meetings.
...
- If electronic voting is on the table, prioritize vendors that offer **audit trails, identity verification, and Canadian data residency**. [ElectoSense](https://electosense.com) provides a secure, Canada-based platform for condo voting, proxy management, and AGM participation.
